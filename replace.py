...
for filepath in html_files:
    ...
    with open(filepath, 'r+', encoding='utf-8') as f:
        ...
        # We will look for <div class="service-grid-card button-card">...</div> where it contains Buton 1
        pattern = r'<div class="service-grid-card button-card">\s*<a[^>]*>Buton 1</a>\s*<a[^>]*>Buton 2</a>.*?</div>'
