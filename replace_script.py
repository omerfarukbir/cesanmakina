...
new_block = """<div class="service-grid-card button-card custom-btn-card">
                ...
                <a href="#" class="custom-action-btn">
                    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#111" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
...
for filepath in html_files:
    ...
    with open(filepath, 'r+', encoding='utf-8') as f:
        ...
        pattern = r'<div class="service-grid-card button-card">\s*<a href="#" class="btn-action">Buton 1</a>\s*<a href="#" class="btn-action outline">Buton 2</a>\s*</div>'
        new_content, num_subs = re.subn(pattern, new_block, content, flags=re.DOTALL)
